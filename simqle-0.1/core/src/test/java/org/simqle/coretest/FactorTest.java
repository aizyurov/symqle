...
public class FactorTest extends SqlTestCase {
    ...
    public void testShow() throws Exception {
        ...
        final String sql2 = person.id.opposite().show(GenericDialect.get());
    ...
    public void testOrderAsc() throws Exception {
        String sql = person.id.opposite().orderAsc().show();
        assertSimilar("SELECT - T0.id AS C0 FROM person AS T0 ORDER BY C0", sql);
    }

    public void testOrderDesc() throws Exception {
        String sql = person.id.opposite().orderDesc().show();
    ...
    public void testContains() throws Exception {
        final String sql = employee.id.where(person.id.opposite().contains(-1L)).show();
