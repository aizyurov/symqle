...
public class WhenClauseListTest extends SqlTestCase {
    ...
    public void testList() throws Exception {
        new Scenario() {
            @Override
            protected void runQuery(final AbstractSearchedWhenClauseList<String> whenClause, final DatabaseGate gate) throws SQLException {
    ...
    private static abstract class Scenario {
        ...
        protected abstract void runQuery(final AbstractSearchedWhenClauseList<String> whenClause, final DatabaseGate gate) throws SQLException;
    }
