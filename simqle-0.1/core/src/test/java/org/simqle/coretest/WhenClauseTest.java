...
public class WhenClauseTest extends SqlTestCase {
    ...
    public void testChain() throws Exception {
        final String sql = person.age.gt(50L).then(person.name).orWhen(person.age.gt(20L).then(person.name.concat(" Jr."))).orElse(person.nick).show();
    ...
    public void testThenNull() throws Exception {
        final String sql = person.age.gt(50L).then(person.name).orWhen(person.age.gt(20L).thenNull()).orElse(person.nick).show();
    ...
    public void testSelectAll() throws Exception {
        final String sql = person.age.gt(20L).then(person.name).all().show();
        assertSimilar("SELECT ALL CASE WHEN T0.age > ? THEN T0.name END AS C0 FROM person AS T0", sql);
    }

    public void testSelectDistinct() throws Exception {
        final String sql = person.age.gt(20L).then(person.name).distinct().show();
        assertSimilar("SELECT DISTINCT CASE WHEN T0.age > ? THEN T0.name END AS C0 FROM person AS T0", sql);
    }

    public void testWhere() throws Exception {
        final String sql = person.age.gt(20L).then(person.name).where(person.name.eq("John")).show();
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.name END AS C0 FROM person AS T0 WHERE T0.name = ?", sql);

    }

    public void testEq() throws Exception {
        final String sql = person.id.where(person.age.gt(20L).then(person.name).eq(person.nick)).show();
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END = T0.nick", sql);
    }

    public void testNe() throws Exception {
        final String sql = person.id.where(person.age.gt(20L).then(person.name).ne(person.nick)).show();
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END <> T0.nick", sql);
    }

    public void testGt() throws Exception {
        final String sql = person.id.where(person.age.gt(20L).then(person.name).gt(person.nick)).show();
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END > T0.nick", sql);
    }

    public void testGe() throws Exception {
        final String sql = person.id.where(person.age.gt(20L).then(person.name).ge(person.nick)).show();
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END >= T0.nick", sql);
    }

    public void testLt() throws Exception {
        final String sql = person.id.where(person.age.gt(20L).then(person.name).lt(person.nick)).show();
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END < T0.nick", sql);
    }

    public void testLe() throws Exception {
        final String sql = person.id.where(person.age.gt(20L).then(person.name).le(person.nick)).show();
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END <= T0.nick", sql);
    }

    public void testEqValue() throws Exception {
        final String sql = person.id.where(person.age.gt(20L).then(person.name).eq("John")).show();
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END = ?", sql);
    }

    public void testNeValue() throws Exception {
        final String sql = person.id.where(person.age.gt(20L).then(person.name).ne("John")).show();
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END <> ?", sql);
    }

    public void testGtValue() throws Exception {
        final String sql = person.id.where(person.age.gt(20L).then(person.name).gt("John")).show();
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END > ?", sql);
    }

    public void testGeValue() throws Exception {
        final String sql = person.id.where(person.age.gt(20L).then(person.name).ge("John")).show();
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END >= ?", sql);
    }

    public void testLtValue() throws Exception {
        final String sql = person.id.where(person.age.gt(20L).then(person.name).lt("John")).show();
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END < ?", sql);
    }

    public void testLeValue() throws Exception {
        final String sql = person.id.where(person.age.gt(20L).then(person.name).le("John")).show();
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END <= ?", sql);
    }

    public void testIn() throws Exception {
        final String sql = person.id.where(person.age.gt(20L).then(person.name).in(person2.nick)).show();
    ...
    public void testNotIn() throws Exception {
        final String sql = person.id.where(person.age.gt(20L).then(person.name).notIn(person2.nick)).show();
    ...
    public void testAsInSubquery() throws Exception {
        final String sql = person2.id.where(person2.nick.in(person.age.gt(20L).then(person.name))).show();
    ...
    public void testAsElseArgument() throws Exception {
        final String sql = person.age.gt(50L).then(person.name).orElse(person.age.lt(20L).then(person.nick)).show();
    ...
    public void testBooleanValue() throws Exception {
        String sql = person.id.where(person.age.gt(20L).then(person.id).booleanValue()).show();
    ...
    public void testMult() throws Exception {
        String sql = person.age.gt(20L).then(person.id).mult(person.id.mult(two)).show();
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.id END *(T0.id * ?) AS C0 FROM person AS T0", sql);
    }

    public void testMultNumber() throws Exception {
        String sql = person.age.gt(20L).then(person.id).mult(2).show();
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.id END * ? AS C0 FROM person AS T0", sql);
    }


    public void testDiv() throws Exception {
        String sql = person.age.gt(20L).then(person.id).div(person.id.mult(two)).show();
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.id END /(T0.id * ?) AS C0 FROM person AS T0", sql);
    }

    public void testDivNumber() throws Exception {
        String sql = person.age.gt(20L).then(person.id).div(2).show();
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.id END / ? AS C0 FROM person AS T0", sql);
    }

    public void testConcat() throws Exception {
        final String sql = person.age.gt(20L).then(person.name).concat(person.nick).show();
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.name END || T0.nick AS C0 FROM person AS T0", sql);
    }

    public void testConcatString() throws Exception {
        final String sql = person.age.gt(20L).then(person.name).concat(" test").show();
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.name END || ? AS C0 FROM person AS T0", sql);
    }
    ...
    public void testUnionAll() throws Exception {
        final String sql = person.age.gt(20L).then(person.name).unionAll(person2.nick).show();
    ...
    public void testUnionDistinct() throws Exception {
        final String sql = person.age.gt(20L).then(person.name).unionDistinct(person2.nick).show();
    ...
    public void testExcept() throws Exception {
        final String sql = person.age.gt(20L).then(person.name).except(person2.nick).show();
    ...
    public void testExceptAll() throws Exception {
        final String sql = person.age.gt(20L).then(person.name).exceptAll(person2.nick).show();
    ...
    public void testExceptDistinct() throws Exception {
        final String sql = person.age.gt(20L).then(person.name).exceptDistinct(person2.nick).show();
    ...
    public void testIntersect() throws Exception {
        final String sql = person.age.gt(20L).then(person.name).intersect(person2.nick).show();
    ...
    public void testIntersectAll() throws Exception {
        final String sql = person.age.gt(20L).then(person.name).intersectAll(person2.nick).show();
    ...
    public void testIntersectDistinct() throws Exception {
        final String sql = person.age.gt(20L).then(person.name).intersectDistinct(person2.nick).show();
    ...
    public void testExists() throws Exception {
        final String sql = employee.id.where(person.age.gt(20L).then(person.name).exists()).show();
    ...
    public void testForUpdate() throws Exception {
        final String sql = person.age.gt(20L).then(person.name).forUpdate().show();
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.name END AS C0 FROM person AS T0 FOR UPDATE", sql);
    }

    public void testForReadOnly() throws Exception {
        final String sql = person.age.gt(20L).then(person.name).forReadOnly().show();
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.name END AS C0 FROM person AS T0 FOR READ ONLY", sql);
    }

    public void testQueryValue() throws Exception {
        final String sql = person.age.gt(20L).then(person.name).queryValue().where(employee.name.isNotNull()).show();
    ...
    public void testIsNull() throws Exception {
        final String sql = person.id.where(person.age.gt(20L).then(person.name).isNull()).show();
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END IS NULL", sql);
    }

    public void testIsNotNull() throws Exception {
        final String sql = person.id.where(person.age.gt(20L).then(person.name).isNotNull()).show();
    ...
    public void testNotLike() throws Exception {
        final String sql = person.id.where(person.age.gt(20L).then(person.name).notLike(DynamicParameter.create(Mappers.STRING, "J%"))).show();
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END NOT LIKE ?", sql);
    }

    public void testLikeString() throws Exception {
        final String sql = person.id.where(person.age.gt(20L).then(person.name).like("J%")).show();
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END LIKE ?", sql);
    }

    public void testNotLikeString() throws Exception {
        final String sql = person.id.where(person.age.gt(20L).then(person.name).notLike("J%")).show();
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END NOT LIKE ?", sql);
    }
    ...
    public void testList() throws Exception {
        new Scenario() {
            @Override
            protected void runQuery(final AbstractSearchedWhenClause<String> whenClause, final DataSource datasource) throws SQLException {
    ...
    private static abstract class Scenario {
        ...
        protected abstract void runQuery(final AbstractSearchedWhenClause<String> whenClause, final DataSource datasource) throws SQLException;
    }
