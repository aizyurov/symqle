...
public class FactorTest extends AbstractIntegrationTestBase {
    ...
    public void testList() throws Exception {
        ...
        final List<Double> list = createFactor(employee).list(getDialectDataSource());
    ...
    public void testMap() throws Exception {
        final Employee employee = new Employee();
        final List<Integer> list = createFactor(employee).map(Mappers.INTEGER).list(getDialectDataSource());
        Collections.sort(list);
    ...
    public void testAll() throws Exception {
        final Employee employee = new Employee();
        final List<Double> list = createFactor(employee).all().list(getDialectDataSource());
        Collections.sort(list);
        assertEquals(Arrays.asList(-3000.0, -3000.0, -2000.0, -2000.0, -1500.0), list);
    }
    ...
    public void testDistinct() throws Exception {
        final Employee employee = new Employee();
        final List<Double> list = createFactor(employee).distinct().list(getDialectDataSource());
        Collections.sort(list);
    ...
    public void testWhere() throws Exception {
        final Employee employee = new Employee();
        final List<Double> list = createFactor(employee).where(employee.retired.booleanValue().negate()).list(getDialectDataSource());
        Collections.sort(list);
    ...
    public void testEq() throws Exception {
        final Employee employee = new Employee();
        final List<String> list = employee.lastName.where(createFactor(employee).eq(employee.salary)).list(getDialectDataSource());
    ...
    public void testOpposite() throws Exception {
        final Employee employee = new Employee();
        final List<Double> list = createFactor(employee).opposite().list(getDialectDataSource());
        Collections.sort(list);
    ...
    public void testMult() throws Exception {
        final Employee employee = new Employee();
        final List<Number> list = createFactor(employee).mult(employee.salary.div(createFactor(employee))).list(getDialectDataSource());
        final List<Double> actual = new ArrayList<Double>();
        for (Number number : list) {
            actual.add(number.doubleValue());
        }
    ...
    public void testDiv() throws Exception {
        final Employee employee = new Employee();
        final List<Number> list = createFactor(employee).div(createFactor(employee).div(employee.salary)).list(getDialectDataSource());
        final List<Double> actual = new ArrayList<Double>();
        for (Number number : list) {
            actual.add(number.doubleValue());
        }
    ...
    public void testMultNumber() throws Exception {
        final Employee employee = new Employee();
        final List<Number> list = createFactor(employee).mult(2).list(getDialectDataSource());
        final List<Double> actual = new ArrayList<Double>();
        for (Number number : list) {
            actual.add(number.doubleValue());
        }
    ...
    public void testDivNumber() throws Exception {
        final Employee employee = new Employee();
        final List<Number> list = createFactor(employee).div(0.5).list(getDialectDataSource());
        final List<Double> actual = new ArrayList<Double>();
        for (Number number : list) {
            actual.add(number.doubleValue());
        }
    ...
    public void testOrderBy() throws Exception {
        final Employee employee = new Employee();
        final List<Double> list = createFactor(employee).orderBy(createFactor(employee)).list(getDialectDataSource());
        assertEquals(Arrays.asList(-3000.0, -3000.0, -2000.0, -2000.0, -1500.0), list);
    }
    ...
    public void testOrderByNullsFirst() throws Exception {
        final Employee employee = new Employee();
        try {
            final List<Double> list = createFactor(employee).orderBy(createFactor(employee).nullsFirst()).list(getDialectDataSource());
            assertEquals(Arrays.asList(-3000.0, -3000.0, -2000.0, -2000.0, -1500.0), list);
        } catch (SQLException e) {
    ...
    public void testOrderByNullsLast() throws Exception {
        final Employee employee = new Employee();
        try {
            final List<Double> list = createFactor(employee).orderBy(createFactor(employee).nullsLast()).list(getDialectDataSource());
            assertEquals(Arrays.asList(-3000.0, -3000.0, -2000.0, -2000.0, -1500.0), list);
        } catch (SQLException e) {
            // mysql does not support NULLS FIRST
            expectSQLException(e, "mysql");
    ...
    public void testOrderByAsc() throws Exception {
        final Employee employee = new Employee();
        final List<Double> list = createFactor(employee).orderBy(createFactor(employee).asc()).list(getDialectDataSource());
        assertEquals(Arrays.asList(-3000.0, -3000.0, -2000.0, -2000.0, -1500.0), list);
    }

    public void testOrderByDesc() throws Exception {
        final Employee employee = new Employee();
        final List<Double> list = createFactor(employee).orderBy(createFactor(employee).desc()).list(getDialectDataSource());
        assertEquals(Arrays.asList(-1500.0, -2000.0, -2000.0, -3000.0, -3000.0), list);
    }

    public void testUnionAll() throws Exception {
        final Employee employee = new Employee();
        final List<Double> list = createFactor(employee).unionAll(employee.salary.where(employee.lastName.eq("Cooper"))).list(getDialectDataSource());
        Collections.sort(list);
    ...
    public void testUnionDistinct() throws Exception {
        final Employee employee = new Employee();
        final List<Double> list = createFactor(employee).unionDistinct(employee.salary.opposite().where(employee.lastName.eq("Cooper"))).list(getDialectDataSource());
        Collections.sort(list);
        assertEquals(Arrays.asList(-3000.0, -2000.0, -1500.0), list);
    ...
    public void testUnion() throws Exception {
        final Employee employee = new Employee();
        final List<Double> list = createFactor(employee).union(employee.salary.opposite().where(employee.lastName.eq("Cooper"))).list(getDialectDataSource());
        Collections.sort(list);
        assertEquals(Arrays.asList(-3000.0, -2000.0, -1500.0), list);
    ...
    public void testExceptAll() throws Exception {
        final Employee employee = new Employee();
        try {
            final List<Double> list = createFactor(employee).exceptAll(createFactor(employee).where(employee.lastName.eq("Cooper"))).list(getDialectDataSource());
            Collections.sort(list);
            assertEquals(Arrays.asList(-3000.0, -3000.0, -2000.0, -2000.0), list);
        } catch (SQLException e) {
    ...
    public void testExceptDistinct() throws Exception {
        final Employee employee = new Employee();
        try {
            final List<Double> list = createFactor(employee).exceptDistinct(createFactor(employee).where(employee.lastName.eq("Cooper"))).list(getDialectDataSource());
            Collections.sort(list);
    ...
    public void testExcept() throws Exception {
        final Employee employee = new Employee();
        try {
            final List<Double> list = createFactor(employee).except(createFactor(employee).where(employee.lastName.eq("Cooper"))).list(getDialectDataSource());
            Collections.sort(list);
            assertEquals(Arrays.asList(-3000.0, -2000.0), list);
        } catch (SQLException e) {
            // mysql: does not support EXCEPT
    ...
    public void testIntersectAll() throws Exception {
        final Employee employee = new Employee();
        try {
            final List<Double> list = createFactor(employee).intersectAll(createFactor(employee).where(employee.lastName.ne("Cooper"))).list(getDialectDataSource());
            Collections.sort(list);
            assertEquals(Arrays.asList(-3000.0, -3000.0, -2000.0, -2000.0), list);
        } catch (SQLException e) {
    ...
    public void testIntersectDistinct() throws Exception {
        final Employee employee = new Employee();
        try {
            final List<Double> list = createFactor(employee).intersectDistinct(createFactor(employee).where(employee.lastName.ne("Cooper"))).list(getDialectDataSource());
            Collections.sort(list);
            assertEquals(Arrays.asList(-3000.0, -2000.0), list);
        } catch (SQLException e) {
            // mysql: does not support INTERSECT
    ...
    public void testIntersect() throws Exception {
        final Employee employee = new Employee();
        try {
            final List<Double> list = createFactor(employee).intersect(createFactor(employee).where(employee.lastName.ne("Cooper"))).list(getDialectDataSource());
            Collections.sort(list);
            assertEquals(Arrays.asList(-3000.0, -2000.0), list);
        } catch (SQLException e) {
            // mysql: does not support INTERSECT
    ...
    public void testForUpdate() throws Exception {
        final Employee employee = new Employee();
        final List<Double> list = createFactor(employee).forUpdate().list(getDialectDataSource());
        Collections.sort(list);
        assertEquals(Arrays.asList(-3000.0, -3000.0, -2000.0, -2000.0, -1500.0), list);
    }
    ...
    public void testForReadOnly() throws Exception {
        final Employee employee = new Employee();
        try {
            final List<Double> list = createFactor(employee).forReadOnly().list(getDialectDataSource());
            Collections.sort(list);
            assertEquals(Arrays.asList(-3000.0, -3000.0, -2000.0, -2000.0, -1500.0), list);
        } catch (SQLException e) {
    ...
    public void testQueryValueNegative() throws Exception {
        ...
        final Employee employee = new Employee();
        try {
            createFactor(employee).queryValue().pair(department.deptName).list(getDialectDataSource());
