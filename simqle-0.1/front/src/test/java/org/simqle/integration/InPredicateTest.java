...
import org.simqle.sql.AbstractInPredicate;
...
public class InPredicateTest extends AbstractIntegrationTestBase {
    ...
    public void testThen() throws Exception {
        ...
        assertEquals(Arrays.asList(Pair.of("Cooper", "James"), Pair.of("First", "James"), Pair.of("March", null), Pair.of("Pedersen", null), Pair.of("Redwood", "Margaret")), list);
    }
