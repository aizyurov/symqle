...
create table department (dept_id INTEGER GENERATED BY DEFAULT AS IDENTITY, dept_name VARCHAR(100) NOT NULL, manager_id INTEGER, parent_dept INTEGER, country_id INTEGER)

create table employee (emp_id INTEGER GENERATED BY DEFAULT AS IDENTITY, first_name VARCHAR(30), last_name VARCHAR(50), title VARCHAR(50),
...
insert into employee (first_name, last_name, title, hire_date, salary, dept_id, is_retired) select 'John', 'Cooper',
 'hacker', '2009-01-12', 1500, dept_id, false
  from department d where d.dept_name = 'DEV'
