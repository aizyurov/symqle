...
public class BooleanPrimaryTest extends SqlTestCase {
    ...
    public void testPair() throws Exception {
        final String sql = person.alive.booleanValue().pair(person.smart.booleanValue()).show();
        assertSimilar("SELECT T0.alive AS C0, T0.smart AS C1 FROM person AS T0", sql);
    }
    ...
    public void testSelect() throws Exception {
        final String sql = person.alive.booleanValue().show();
        assertSimilar("SELECT T0.alive AS C0 FROM person AS T0", sql);
    }

    public void testSelectAll() throws Exception {
        final String sql = person.alive.booleanValue().all().show();
        assertSimilar("SELECT ALL T0.alive AS C0 FROM person AS T0", sql);
    }

    public void testSelectDistinct() throws Exception {
        final String sql = person.alive.booleanValue().distinct().show();
        assertSimilar("SELECT DISTINCT T0.alive AS C0 FROM person AS T0", sql);
    }

    public void testWhere() throws Exception {
        final String sql = person.alive.booleanValue().where(person.smart.booleanValue()).show();
        assertSimilar("SELECT T0.alive AS C0 FROM person AS T0 WHERE T0.smart", sql);
    ...
    public void testIn() throws Exception {
        String sql = person.id.where(person.smart.booleanValue().in(person2.alive.booleanValue())).show();
        assertSimilar("SELECT T1.id AS C1 FROM person AS T1 WHERE(T1.smart) IN(SELECT T2.alive FROM person AS T2)", sql);
    }

    public void testNotIn() throws Exception {
        String sql = person.id.where(person.smart.booleanValue().notIn(person2.alive.booleanValue())).show();
        assertSimilar("SELECT T1.id AS C1 FROM person AS T1 WHERE(T1.smart) NOT IN(SELECT T2.alive FROM person AS T2)", sql);
    }

    public void testInList() throws Exception {
        String sql = person.id.where(person.smart.booleanValue().in(person.alive.booleanValue(), person.friendly.booleanValue())).show();
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE(T0.smart) IN(T0.alive, T0.friendly)", sql);
   }

    public void testNotInList() throws Exception {
        String sql = person.id.where(person.smart.booleanValue().notIn(person.alive.booleanValue(), person.friendly.booleanValue())).show();
    ...
    public void testPlusNumber() throws Exception {
        String sql = person.smart.booleanValue().plus(2).show();
        assertSimilar("SELECT(T0.smart) + ? AS C0 FROM person AS T0", sql);
    }

    public void testBooleanValue() throws Exception {
        String sql = person.smart.booleanValue().booleanValue().show();
        assertSimilar("SELECT(T0.smart) AS C0 FROM person AS T0", sql);
    }

    public void testMinus() throws Exception {
        String sql = person.smart.booleanValue().minus(person.alive.booleanValue()).show();
        assertSimilar("SELECT(T0.smart) -(T0.alive) AS C0 FROM person AS T0", sql);
    }

    public void testMinusNumber() throws Exception {
        String sql = person.smart.booleanValue().minus(2).show();
        assertSimilar("SELECT(T0.smart) - ? AS C0 FROM person AS T0", sql);
    }

    public void testMult() throws Exception {
        String sql = person.smart.booleanValue().mult(person.alive.booleanValue()).show();
        assertSimilar("SELECT(T0.smart) *(T0.alive) AS C0 FROM person AS T0", sql);
    }

    public void testMultNumber() throws Exception {
        String sql = person.smart.booleanValue().mult(2).show();
        assertSimilar("SELECT(T0.smart) * ? AS C0 FROM person AS T0", sql);
    }

    public void testDiv() throws Exception {
        String sql = person.smart.booleanValue().div(person.alive.booleanValue()).show();
        assertSimilar("SELECT(T0.smart) /(T0.alive) AS C0 FROM person AS T0", sql);
    }

    public void testDivNumber() throws Exception {
        String sql = person.smart.booleanValue().div(2).show();
        assertSimilar("SELECT(T0.smart) / ? AS C0 FROM person AS T0", sql);
    }

    public void testConcat() throws Exception {
        String sql = person.smart.booleanValue().concat(person.alive.booleanValue()).show();
        assertSimilar("SELECT(T0.smart) ||(T0.alive) AS C0 FROM person AS T0", sql);
    }

    public void testConcatString() throws Exception {
        String sql = person.smart.booleanValue().concat(" test").show();
        assertSimilar("SELECT(T0.smart) || ? AS C0 FROM person AS T0", sql);
    }
    
    public void testOrderBy() throws Exception {
        String sql = person.alive.booleanValue().orderBy(person.smart.booleanValue()).show();
        assertSimilar("SELECT T0.alive AS C0 FROM person AS T0 ORDER BY T0.smart", sql);
    }

    public void testOrderByNullsFirst() throws Exception {
        String sql = person.id.orderBy(person.smart.booleanValue().nullsFirst()).show();
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 ORDER BY T0.smart NULLS FIRST", sql);
    }

    public void testOrderByNullsLast() throws Exception {
        String sql = person.id.orderBy(person.smart.booleanValue().nullsLast()).show();
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 ORDER BY T0.smart NULLS LAST", sql);
    }

    public void testOrderByDesc() throws Exception {
        String sql = person.id.orderBy(person.smart.booleanValue().desc()).show();
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 ORDER BY T0.smart DESC", sql);
    }

    public void testOrderByAsc() throws Exception {
        String sql = person.id.orderBy(person.smart.booleanValue().asc()).show();
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 ORDER BY T0.smart ASC", sql);
    }

    public void testUnion() throws Exception {
        final String sql = person.alive.booleanValue().union(person2.alive.booleanValue()).show();
        assertSimilar("SELECT T0.alive AS C0 FROM person AS T0 UNION SELECT T1.alive AS C0 FROM person AS T1", sql);
    }
    
    public void testUnionAll() throws Exception {
        final String sql = person.alive.booleanValue().unionAll(person2.alive.booleanValue()).show();
        assertSimilar("SELECT T0.alive AS C0 FROM person AS T0 UNION ALL SELECT T1.alive AS C0 FROM person AS T1", sql);
    }

    public void testUnionDistinct() throws Exception {
        final String sql = person.alive.booleanValue().unionDistinct(person2.alive.booleanValue()).show();
        assertSimilar("SELECT T0.alive AS C0 FROM person AS T0 UNION DISTINCT SELECT T1.alive AS C0 FROM person AS T1", sql);
    }

    public void testExcept() throws Exception {
        final String sql = person.alive.booleanValue().except(person2.alive.booleanValue()).show();
        assertSimilar("SELECT T0.alive AS C0 FROM person AS T0 EXCEPT SELECT T1.alive AS C0 FROM person AS T1", sql);
    }

    public void testExceptAll() throws Exception {
        final String sql = person.alive.booleanValue().exceptAll(person2.alive.booleanValue()).show();
        assertSimilar("SELECT T0.alive AS C0 FROM person AS T0 EXCEPT ALL SELECT T1.alive AS C0 FROM person AS T1", sql);
    }

    public void testExceptDistinct() throws Exception {
        final String sql = person.alive.booleanValue().exceptDistinct(person2.alive.booleanValue()).show();
        assertSimilar("SELECT T0.alive AS C0 FROM person AS T0 EXCEPT DISTINCT SELECT T1.alive AS C0 FROM person AS T1", sql);
    }

    public void testIntersect() throws Exception {
        final String sql = person.alive.booleanValue().intersect(person2.alive.booleanValue()).show();
        assertSimilar("SELECT T0.alive AS C0 FROM person AS T0 INTERSECT SELECT T1.alive AS C0 FROM person AS T1", sql);
    }

    public void testIntersectAll() throws Exception {
        final String sql = person.alive.booleanValue().intersectAll(person2.alive.booleanValue()).show();
        assertSimilar("SELECT T0.alive AS C0 FROM person AS T0 INTERSECT ALL SELECT T1.alive AS C0 FROM person AS T1", sql);
    }

    public void testIntersectDistinct() throws Exception {
        final String sql = person.alive.booleanValue().intersectDistinct(person2.alive.booleanValue()).show();
        assertSimilar("SELECT T0.alive AS C0 FROM person AS T0 INTERSECT DISTINCT SELECT T1.alive AS C0 FROM person AS T1", sql);
    }

    public void testExists() throws Exception {
        final String sql = person2.id.where(person.alive.booleanValue().exists()).show();
        assertSimilar("SELECT T1.id AS C0 FROM person AS T1 WHERE EXISTS(SELECT T0.alive FROM person AS T0)", sql);
    }

    public void testForUpdate() throws Exception {
        final String sql = person.alive.booleanValue().forUpdate().show();
        assertSimilar("SELECT T0.alive AS C0 FROM person AS T0 FOR UPDATE", sql);
    }

    public void testForReadOnly() throws Exception {
        final String sql = person.alive.booleanValue().forReadOnly().show();
        assertSimilar("SELECT T0.alive AS C0 FROM person AS T0 FOR READ ONLY", sql);
    }

    public void testSubquery() throws Exception {
        final String sql = person.alive.booleanValue().queryValue().where(person2.alive.booleanValue()).show();
        assertSimilar("SELECT(SELECT T0.alive FROM person AS T0) AS C1 FROM person AS T1 WHERE T1.alive", sql);
    }
    ...
    public void testList() throws Exception {
        ...
        final String queryString = person.alive.booleanValue().show();
        ...
        final List<Boolean> list = person.alive.booleanValue().list(datasource);
    ...
    public void testScroll() throws Exception {
        ...
        person.alive.booleanValue().scroll(datasource, new Callback<Boolean, SQLException>() {
            int callCount = 0;
