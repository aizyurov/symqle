...
public class QueryExpressionScalarTest extends SqlTestCase {
    ...
    public void testSort() throws Exception {
        final String sql = person.name.orderBy(employee.id.where(employee.id.eq(person.id)).except(manager.id.where(manager.id.eq(person.id)))).show();
    ...
    public void testSortAsc() throws Exception {
        final String sql = person.name.orderBy(employee.id.where(employee.id.eq(person.id)).except(manager.id.where(manager.id.eq(person.id))).asc()).show();
    ...
    public void testSortDesc() throws Exception {
        final String sql = person.name.orderBy(employee.id.where(employee.id.eq(person.id)).except(manager.id.where(manager.id.eq(person.id))).desc()).show();
    ...
    public void testSortNullsFirst() throws Exception {
        final String sql = person.name.orderBy(employee.id.where(employee.id.eq(person.id)).except(manager.id.where(manager.id.eq(person.id))).nullsFirst()).show();
    ...
    public void testSortNullsLast() throws Exception {
        final String sql = person.name.orderBy(employee.id.where(employee.id.eq(person.id)).except(manager.id.where(manager.id.eq(person.id))).nullsLast()).show();
