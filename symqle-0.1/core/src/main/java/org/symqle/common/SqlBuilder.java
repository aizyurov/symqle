 ...
 */
public interface SqlBuilder extends Parameterizer {

    /**
     * Appends the text of this SqlBuilder to an SqlBuilder.
     ...
     * We need it for correct separation of tokens when concatenating.
