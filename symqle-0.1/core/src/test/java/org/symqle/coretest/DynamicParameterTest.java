...
public class DynamicParameterTest extends SqlTestCase {
    ...
    public void testAsFunctionArgument() throws Exception {
        final DynamicParameter<Long> param = DynamicParameter.create(CoreMappers.LONG, 1L);
        final Column<Long> id = person.id;
        final String sql = SqlFunction.create("abs", CoreMappers.LONG).apply(param).where(id.asPredicate()).show(new GenericDialect());
    ...
    public void testSubstring() throws Exception {
        final String sql = DynamicParameter.create(CoreMappers.STRING, "abcd").substring(person.id).show(new GenericDialect());
        assertSimilar("SELECT SUBSTRING(? FROM T0.id) AS C0 FROM person AS T0", sql);
    }

    public void testSubstring2() throws Exception {
        final String sql = DynamicParameter.create(CoreMappers.STRING, "abcd").substring(person.id, person.id.div(2)).show(new GenericDialect());
    ...
    public void testSubstringParam() throws Exception {
        final String sql = DynamicParameter.create(CoreMappers.STRING, "abcd").substring(2).pair(person.id).show(new GenericDialect());
    ...
    public void testSubstringParam2() throws Exception {
        final String sql = DynamicParameter.create(CoreMappers.STRING, "abcd").substring(2, 5).pair(person.id).show(new GenericDialect());
        assertSimilar("SELECT SUBSTRING(? FROM ? FOR ?) AS C0, T0.id AS C1 FROM person AS T0", sql);
    }

    public void testPosition() throws Exception {
        final String sql = DynamicParameter.create(CoreMappers.STRING, "abcd").positionOf(person.name).show(new GenericDialect());
        assertSimilar("SELECT POSITION(T0.name IN ?) AS C0 FROM person AS T0", sql);
    }

    public void testPositionParam() throws Exception {
        final String sql = DynamicParameter.create(CoreMappers.STRING, "abcd").positionOf("bc").pair(person.id).show(new GenericDialect());
...
//        assertSimilar("SELECT ? AS C0 FROM dual AS D727817162 UNION SELECT T0.id AS C0 FROM person AS T0", sql);
    ...
    public void testLimit() throws Exception {
        final String sql = DynamicParameter.create(CoreMappers.LONG, 1L).limit(20).show(new OracleLikeDialect(), Option.allowNoTables(true));
        assertSimilar("SELECT ? AS C0 FROM dual AS T0 FETCH FIRST 20 ROWS ONLY", sql);
    }

    public void testLimit2() throws Exception {
        final String sql = DynamicParameter.create(CoreMappers.LONG, 1L).limit(10, 20).show(new OracleLikeDialect(), Option.allowNoTables(true));
    ...
    public void testLike() throws Exception {
        final String sql = person.id.where(DynamicParameter.create(CoreMappers.STRING, "John").like(person.name)).show(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE ? LIKE T0.name", sql);
    }

    public void testLikeString() throws Exception {
        final String sql = person.id.where(DynamicParameter.create(CoreMappers.STRING, "John").like("J%")).show(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE ? LIKE ?", sql);
    }

    public void testNotLike() throws Exception {
        final String sql = person.id.where(DynamicParameter.create(CoreMappers.STRING, "John").notLike(person.name)).show(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE ? NOT LIKE T0.name", sql);
    }

    public void testNotLikeString() throws Exception {
        final String sql = person.id.where(DynamicParameter.create(CoreMappers.STRING, "John").notLike("J%")).show(new GenericDialect());
