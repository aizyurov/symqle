...
public class LikePredicateBaseTest extends SqlTestCase {
    ...
    public void testIsNull() throws Exception {
        final String sql = person.id.where(person.name.like(person.nick).isNull()).show(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE(T0.name LIKE T0.nick) IS NULL", sql);
    }

    public void testIsNotNull() throws Exception {
        final String sql = person.id.where(person.name.like(person.nick).isNotNull()).show(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE(T0.name LIKE T0.nick) IS NOT NULL", sql);
    }

    public void testEq() throws Exception {
        final String sql = person.id.where(person.name.like(person.nick).eq(person.alive)).show(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE(T0.name LIKE T0.nick) = T0.alive", sql);
    }

    public void testNe() throws Exception {
        final String sql = person.id.where(person.name.like(person.nick).ne(person.alive)).show(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE(T0.name LIKE T0.nick) <> T0.alive", sql);
    }

    public void testGt() throws Exception {
        final String sql = person.id.where(person.name.like(person.nick).gt(person.alive)).show(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE(T0.name LIKE T0.nick) > T0.alive", sql);
    }

    public void testGe() throws Exception {
        final String sql = person.id.where(person.name.like(person.nick).ge(person.alive)).show(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE(T0.name LIKE T0.nick) >= T0.alive", sql);
    }

    public void testLt() throws Exception {
        final String sql = person.id.where(person.name.like(person.nick).lt(person.alive)).show(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE(T0.name LIKE T0.nick) < T0.alive", sql);
    }

    public void testLe() throws Exception {
        final String sql = person.id.where(person.name.like(person.nick).le(person.alive)).show(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE(T0.name LIKE T0.nick) <= T0.alive", sql);
    }

    public void testEqValue() throws Exception {
        final String sql = person.id.where(person.name.like(person.nick).eq(true)).show(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE(T0.name LIKE T0.nick) = ?", sql);
    }

    public void testNeValue() throws Exception {
        final String sql = person.id.where(person.name.like(person.nick).ne(true)).show(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE(T0.name LIKE T0.nick) <> ?", sql);
    }

    public void testGtValue() throws Exception {
        final String sql = person.id.where(person.name.like(person.nick).gt(true)).show(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE(T0.name LIKE T0.nick) > ?", sql);
    }

    public void testGeValue() throws Exception {
        final String sql = person.id.where(person.name.like(person.nick).ge(true)).show(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE(T0.name LIKE T0.nick) >= ?", sql);
    }

    public void testLtValue() throws Exception {
        final String sql = person.id.where(person.name.like(person.nick).lt(true)).show(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE(T0.name LIKE T0.nick) < ?", sql);
    }

    public void testLeValue() throws Exception {
        final String sql = person.id.where(person.name.like(person.nick).le(true)).show(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE(T0.name LIKE T0.nick) <= ?", sql);
    }

    public void testIn() throws Exception {
        final String sql = person.id.where(person.name.like(person.nick).in(child.alive.where(child.parentId.eq(person.id)))).show(new GenericDialect());
    ...
    public void testNotIn() throws Exception {
        final String sql = person.id.where(person.name.like(person.nick).notIn(child.alive.where(child.parentId.eq(person.id)))).show(new GenericDialect());
    ...
    public void testInList() throws Exception {
        final String sql = person.id.where(person.name.like(person.nick).in(true, false)).show(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE(T0.name LIKE T0.nick) IN(?, ?)", sql);
   }

    public void testNotInList() throws Exception {
        final String sql = person.id.where(person.name.like(person.nick).notIn(true, false)).show(new GenericDialect());
