...
public class QueryBaseScalarTest extends SqlTestCase {
    ...
    public void testShow() throws Exception {
        ...
        final String sql = qbs.showQuery(new GenericDialect());
        assertSimilar("SELECT ALL T0.id AS C0 FROM person AS T0", sql);
        final String sql2 = qbs.showQuery(new GenericDialect());
    ...
    public void testAdapt() throws Exception {
        ...
        assertEquals(person.id.showQuery(new GenericDialect()), adaptor.showQuery(new GenericDialect()));
    }

    public void testLimit() throws Exception {
        final String sql = createQueryBaseScalar().limit(10).showQuery(new GenericDialect());
        assertSimilar("SELECT ALL T0.id AS C0 FROM person AS T0 FETCH FIRST 10 ROWS ONLY", sql);
    }

    public void testLimit2() throws Exception {
        final String sql = createQueryBaseScalar().limit(10,20).showQuery(new GenericDialect());
    ...
    public void testIn() throws Exception {
        final String sql = person.id.where(employee.id.selectAll().queryValue().in(manager.id.selectAll())).showQuery(new GenericDialect());
    ...
    public void testSort() throws Exception {
        final String sql = person.name.orderBy(employee.name.selectAll().queryValue()).showQuery(new GenericDialect());
    ...
    public void testWhere() throws Exception {
        ...
        final String sql = createQueryBaseScalar().where(person.name.isNotNull()).showQuery(new GenericDialect());
    ...
    public void testAllForUpdate() throws Exception {
        final String sql = createQueryBaseScalar().forUpdate().showQuery(new GenericDialect());
        assertSimilar("SELECT ALL T0.id AS C0 FROM person AS T0 FOR UPDATE", sql);
    }

    public void testDistincgForUpdate() throws Exception {
        final String sql = person.id.distinct().forUpdate().showQuery(new GenericDialect());
    ...
    public void testIntersect() throws Exception {
        final String sql = createQueryBaseScalar().intersect(employee.id).showQuery(new GenericDialect());
        assertSimilar("SELECT ALL T0.id AS C0 FROM person AS T0 INTERSECT SELECT T1.id AS C0 FROM employee AS T1", sql);

    }

    public void testIntersectAll() throws Exception {
        final String sql = createQueryBaseScalar().intersectAll(employee.id).showQuery(new GenericDialect());
    ...
    public void testIntersectDistinct() throws Exception {
        final String sql = createQueryBaseScalar().intersectDistinct(employee.id).showQuery(new GenericDialect());
    ...
    public void testExists() throws Exception {
        final String sql = createQueryBaseScalar().where(employee.name.selectAll().exists()).showQuery(new GenericDialect());
    ...
    public void testQueryValue() throws Exception {
        final String sql = createQueryBaseScalar().queryValue().where(employee.name.isNotNull()).showQuery(new GenericDialect());
