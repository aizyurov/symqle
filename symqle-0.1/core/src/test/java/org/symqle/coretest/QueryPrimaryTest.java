...
public class QueryPrimaryTest extends SqlTestCase {
    ...
    public void testShow() throws Exception {
        final String sql = queryPrimary.showQuery(new GenericDialect());
        final String sql2 = queryPrimary.showQuery(new GenericDialect());
    ...
    public void testContains() throws Exception {
        final String sql = new Employee().name.where(queryPrimary.contains(1)).showQuery(new GenericDialect());
    ...
    public void testInArgument() throws Exception {
        final String sql = new Employee().name.where(DynamicParameter.create(CoreMappers.INTEGER, 1).in(queryPrimary)).showQuery(new GenericDialect());
        assertSimilar("SELECT T2.name AS C2 FROM employee AS T2 WHERE ? IN(SELECT COUNT(T1.id) FROM employee AS T1 WHERE T1.name LIKE ?)", sql);
    }

    public void testExcept() throws Exception {
        final String sql = new Employee().name.where(queryPrimary.except(queryPrimary).contains(1)).showQuery(new GenericDialect());
    ...
    public void testExceptAll() throws Exception {
        final String sql = new Employee().name.where(queryPrimary.exceptAll(queryPrimary).contains(1)).showQuery(new GenericDialect());
    ...
    public void testExceptDistinct() throws Exception {
        final String sql = new Employee().name.where(queryPrimary.exceptDistinct(queryPrimary).contains(1)).showQuery(new GenericDialect());
    ...
    public void testIntersect() throws Exception {
        final String sql = new Employee().name.where(queryPrimary.intersect(queryPrimary).contains(1)).showQuery(new GenericDialect());
    ...
    public void testIntersectAll() throws Exception {
        final String sql = new Employee().name.where(queryPrimary.intersectAll(queryPrimary).contains(1)).showQuery(new GenericDialect());
    ...
    public void testIntersectDistinct() throws Exception {
        final String sql = new Employee().name.where(queryPrimary.intersectDistinct(queryPrimary).contains(1)).showQuery(new GenericDialect());
    ...
    public void testUnion() throws Exception {
        final String sql = new Employee().name.where(queryPrimary.union(queryPrimary).contains(1)).showQuery(new GenericDialect());
    ...
    public void testUnionAll() throws Exception {
        final String sql = new Employee().name.where(queryPrimary.unionAll(queryPrimary).contains(1)).showQuery(new GenericDialect());
    ...
    public void testUnionDistinct() throws Exception {
        final String sql = new Employee().name.where(queryPrimary.unionDistinct(queryPrimary).contains(1)).showQuery(new GenericDialect());
    ...
    public void testExists() throws Exception {
        final String sql = new Employee().name.where(queryPrimary.exists()).showQuery(new GenericDialect());
    ...
    public void testForReadOnly() throws Exception {
        final String sql = queryPrimary.forReadOnly().showQuery(new GenericDialect());
        assertSimilar("SELECT COUNT(T1.id) AS C1 FROM employee AS T1 WHERE T1.name LIKE ? FOR READ ONLY", sql);
    }

    public void testForUpdate() throws Exception {
        final String sql = queryPrimary.forUpdate().showQuery(new GenericDialect());
        assertSimilar("SELECT COUNT(T1.id) AS C1 FROM employee AS T1 WHERE T1.name LIKE ? FOR UPDATE", sql);
    }

    public void testQueryValue() throws Exception {
        final String sql = queryPrimary.queryValue().orderBy(new Employee().id).showQuery(new GenericDialect());
