...
public class WhenClauseTest extends SqlTestCase {
    ...
    public void testSelect() throws Exception {
        ...
        final String sql = whenClause.showQuery(new GenericDialect());
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.name END AS C0 FROM person AS T0", sql);
        assertSimilar(sql, whenClause.showQuery(new GenericDialect()));
    }
    ...
    public void testMap() throws Exception {
        final AbstractSearchedWhenClause<String> whenClause = createWhenClause();
        final String sql = whenClause.map(CoreMappers.STRING).showQuery(new GenericDialect());
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.name END AS C0 FROM person AS T0", sql);
    }
    public void testElse() throws Exception {
        final String sql = createWhenClause().orElse(person.nick).showQuery(new GenericDialect());
    ...
    public void testDynamicParameterElse() throws Exception {
        final String sql = createWhenClause().orElse(DynamicParameter.create(CoreMappers.STRING, "do not care")).showQuery(new GenericDialect());
    ...
    public void testFunctionElse() throws Exception {
        final String sql = createWhenClause().orElse(SqlFunction.create("to_upper", CoreMappers.STRING).apply(person.nick)).showQuery(new GenericDialect());
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.name ELSE to_upper(T0.nick) END AS C0 FROM person AS T0", sql);
    }

    public void testChain() throws Exception {
        final String sql = person.age.gt(50L).then(person.name).orWhen(person.age.gt(20L).then(person.name.concat(" Jr."))).orElse(person.nick).showQuery(new GenericDialect());
    ...
    public void testThenNull() throws Exception {
        final String sql = person.age.gt(50L).then(person.name).orWhen(person.age.gt(20L).thenNull()).orElse(person.nick).showQuery(new GenericDialect());
    ...
    public void testAdapt() throws Exception {
        ...
        assertEquals(whenClause.showQuery(new GenericDialect()), adaptor.showQuery(new GenericDialect()));
        assertEquals(whenClause.getMapper(), adaptor.getMapper());
    }

    public void testWhere() throws Exception {
        final String sql = createWhenClause().where(person.name.eq("John")).showQuery(new GenericDialect());
    ...
    public void testAsInValueList() throws Exception {
        final String sql = person.id.where(person.nick.in(createWhenClause().asInValueList())).showQuery(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE T0.nick IN(CASE WHEN T0.age > ? THEN T0.name END)", sql);

    }

    public void testEq() throws Exception {
        final String sql = person.id.where(createWhenClause().eq(person.nick)).showQuery(new GenericDialect());
    ...
    public void testGt() throws Exception {
        final String sql = person.id.where(createWhenClause().gt(person.nick)).showQuery(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END > T0.nick", sql);
    }

    public void testGe() throws Exception {
        final String sql = person.id.where(createWhenClause().ge(person.nick)).showQuery(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END >= T0.nick", sql);
    }

    public void testLt() throws Exception {
        final String sql = person.id.where(createWhenClause().lt(person.nick)).showQuery(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END < T0.nick", sql);
    }

    public void testLe() throws Exception {
        final String sql = person.id.where(createWhenClause().le(person.nick)).showQuery(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END <= T0.nick", sql);
    }

    public void testEqValue() throws Exception {
        final String sql = person.id.where(createWhenClause().eq("John")).showQuery(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END = ?", sql);
    }

    public void testNeValue() throws Exception {
        final String sql = person.id.where(createWhenClause().ne("John")).showQuery(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END <> ?", sql);
    }

    public void testGtValue() throws Exception {
        final String sql = person.id.where(createWhenClause().gt("John")).showQuery(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END > ?", sql);
    }

    public void testGeValue() throws Exception {
        final String sql = person.id.where(createWhenClause().ge("John")).showQuery(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END >= ?", sql);
    }

    public void testLtValue() throws Exception {
        final String sql = person.id.where(createWhenClause().lt("John")).showQuery(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END < ?", sql);
    }

    public void testLeValue() throws Exception {
        final String sql = person.id.where(createWhenClause().le("John")).showQuery(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END <= ?", sql);
    }

    public void testIn() throws Exception {
        final String sql = person.id.where(createWhenClause().in(person2.nick)).showQuery(new GenericDialect());
    ...
    public void testNotIn() throws Exception {
        final String sql = person.id.where(createWhenClause().notIn(person2.nick)).showQuery(new GenericDialect());
    ...
    public void testInList() throws Exception {
        final String sql = person.id.where(createWhenClause().in("John", "James")).showQuery(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END IN(?, ?)", sql);
   }

    public void testNotInList() throws Exception {
        final String sql = person.id.where(createWhenClause().notIn("John", "James")).showQuery(new GenericDialect());
    ...
    public void testAsInSubquery() throws Exception {
        final String sql = person2.id.where(person2.nick.in(createWhenClause())).showQuery(new GenericDialect());
    ...
    public void testAsElseArgument() throws Exception {
        final String sql = person.age.gt(50L).then(person.name).orElse(person.age.lt(20L).then(person.nick)).showQuery(new GenericDialect());
    ...
    public void testParamWithValue() throws Exception {
        ...
        String sql = searchedWhenClause.add(searchedWhenClause.param(2L)).showQuery(new GenericDialect());
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.id END + ? AS C0 FROM person AS T0", sql);
    }

    public void testParamWithNoValue() throws Exception {
        final AbstractSearchedWhenClause<Long> searchedWhenClause = person.age.gt(20L).then(person.id);
        String sql = searchedWhenClause.add(searchedWhenClause.param()).showQuery(new GenericDialect());
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.id END + ? AS C0 FROM person AS T0", sql);
    }

    public void testBooleanValue() throws Exception {
        String sql = person.id.where(person.age.gt(20L).then(person.id).asPredicate()).showQuery(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.id END", sql);
    }

    public void testSub() throws Exception {
        String sql = person.age.gt(20L).then(person.id).sub(person.id.mult(two)).showQuery(new GenericDialect());
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.id END - T0.id * ? AS C0 FROM person AS T0", sql);
    }

    public void testSubNumber() throws Exception {
        String sql = person.age.gt(20L).then(person.id).sub(2).showQuery(new GenericDialect());
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.id END - ? AS C0 FROM person AS T0", sql);
    }

    public void testMult() throws Exception {
        String sql = person.age.gt(20L).then(person.id).mult(person.id.mult(two)).showQuery(new GenericDialect());
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.id END *(T0.id * ?) AS C0 FROM person AS T0", sql);
    }

    public void testMultNumber() throws Exception {
        String sql = person.age.gt(20L).then(person.id).mult(2).showQuery(new GenericDialect());
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.id END * ? AS C0 FROM person AS T0", sql);
    }


    public void testDiv() throws Exception {
        String sql = person.age.gt(20L).then(person.id).div(person.id.mult(two)).showQuery(new GenericDialect());
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.id END /(T0.id * ?) AS C0 FROM person AS T0", sql);
    }

    public void testDivNumber() throws Exception {
        String sql = person.age.gt(20L).then(person.id).div(2).showQuery(new GenericDialect());
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.id END / ? AS C0 FROM person AS T0", sql);
    }

    public void testConcat() throws Exception {
        final String sql = createWhenClause().concat(person.nick).showQuery(new GenericDialect());
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.name END || T0.nick AS C0 FROM person AS T0", sql);
    }

    public void testConcatString() throws Exception {
        final String sql = createWhenClause().concat(" test").showQuery(new GenericDialect());
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.name END || ? AS C0 FROM person AS T0", sql);
    }

    public void testSubstring() throws Exception {
        final String sql = createWhenClause().substring(person.id).showQuery(new GenericDialect());
    ...
    public void testCharLength() throws Exception {
        final String sql = createWhenClause().charLength().showQuery(new GenericDialect());
        assertSimilar("SELECT CHAR_LENGTH(CASE WHEN T0.age > ? THEN T0.name END) AS C0 FROM person AS T0", sql);
    }

    public void testSubstring2() throws Exception {
        final String sql = createWhenClause().substring(person.id, person.id.div(2)).showQuery(new GenericDialect());
    ...
    public void testSubstringParam() throws Exception {
        final String sql = createWhenClause().substring(2).showQuery(new GenericDialect());
    ...
    public void testSubstringParam2() throws Exception {
        final String sql = createWhenClause().substring(2, 5).showQuery(new GenericDialect());
        assertSimilar("SELECT SUBSTRING(CASE WHEN T0.age > ? THEN T0.name END FROM ? FOR ?) AS C0 FROM person AS T0", sql);
    }

    public void testPosition() throws Exception {
        final String sql = createWhenClause().positionOf(person.nick).showQuery(new GenericDialect());
    ...
    public void testPositionParam() throws Exception {
        final String sql = createWhenClause().positionOf("A").showQuery(new GenericDialect());
    ...
    public void testCollate() throws Exception {
        final String sql = createWhenClause().collate("latin1_general_ci").showQuery(new GenericDialect());
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.name END COLLATE latin1_general_ci AS C0 FROM person AS T0", sql);
    }

    public void testUnion() throws Exception {
        final String sql = createWhenClause().union(person2.nick).showQuery(new GenericDialect());
    ...
    public void testUnionAll() throws Exception {
        final String sql = createWhenClause().unionAll(person2.nick).showQuery(new GenericDialect());
    ...
    public void testUnionDistinct() throws Exception {
        final String sql = createWhenClause().unionDistinct(person2.nick).showQuery(new GenericDialect());
    ...
    public void testExcept() throws Exception {
        final String sql = createWhenClause().except(person2.nick).showQuery(new GenericDialect());
    ...
    public void testExceptAll() throws Exception {
        final String sql = createWhenClause().exceptAll(person2.nick).showQuery(new GenericDialect());
    ...
    public void testExceptDistinct() throws Exception {
        final String sql = createWhenClause().exceptDistinct(person2.nick).showQuery(new GenericDialect());
    ...
    public void testIntersect() throws Exception {
        final String sql = createWhenClause().intersect(person2.nick).showQuery(new GenericDialect());
    ...
    public void testIntersectAll() throws Exception {
        final String sql = createWhenClause().intersectAll(person2.nick).showQuery(new GenericDialect());
    ...
    public void testIntersectDistinct() throws Exception {
        final String sql = createWhenClause().intersectDistinct(person2.nick).showQuery(new GenericDialect());
    ...
    public void testExists() throws Exception {
        final String sql = employee.id.where(createWhenClause().exists()).showQuery(new GenericDialect());
    ...
    public void testForReadOnly() throws Exception {
        final String sql = createWhenClause().forReadOnly().showQuery(new GenericDialect());
        assertSimilar("SELECT CASE WHEN T0.age > ? THEN T0.name END AS C0 FROM person AS T0 FOR READ ONLY", sql);
    }

    public void testQueryValue() throws Exception {
        final String sql = createWhenClause().queryValue().where(employee.name.isNotNull()).showQuery(new GenericDialect());
    ...
    public void testIsNull() throws Exception {
        final String sql = person.id.where(createWhenClause().isNull()).showQuery(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END IS NULL", sql);
    }

    public void testIsNotNull() throws Exception {
        final String sql = person.id.where(createWhenClause().isNotNull()).showQuery(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END IS NOT NULL", sql);
    }

    public void testLike() throws Exception {
        final String sql = person.id.where(createWhenClause().like(DynamicParameter.create(CoreMappers.STRING, "J%"))).showQuery(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END LIKE ?", sql);
    }

    public void testNotLike() throws Exception {
        final String sql = person.id.where(createWhenClause().notLike(DynamicParameter.create(CoreMappers.STRING, "J%"))).showQuery(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END NOT LIKE ?", sql);
    }

    public void testLikeString() throws Exception {
        final String sql = person.id.where(createWhenClause().like("J%")).showQuery(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END LIKE ?", sql);
    }

    public void testNotLikeString() throws Exception {
        final String sql = person.id.where(createWhenClause().notLike("J%")).showQuery(new GenericDialect());
        assertSimilar("SELECT T0.id AS C0 FROM person AS T0 WHERE CASE WHEN T0.age > ? THEN T0.name END NOT LIKE ?", sql);
    }

    public void testCount() throws Exception {
        final String sql = person.age.gt(20L).then(person.age).count().showQuery(new GenericDialect());
        assertSimilar("SELECT COUNT(CASE WHEN T0.age > ? THEN T0.age END) AS C0 FROM person AS T0", sql);
    }

    public void testCountDistinct() throws Exception {
        final String sql = person.age.gt(20L).then(person.age).countDistinct().showQuery(new GenericDialect());
        assertSimilar("SELECT COUNT(DISTINCT CASE WHEN T0.age > ? THEN T0.age END) AS C0 FROM person AS T0", sql);
    }

    public void testAvg() throws Exception {
        final String sql = person.age.gt(20L).then(person.age).avg().showQuery(new GenericDialect());
        assertSimilar("SELECT AVG(CASE WHEN T0.age > ? THEN T0.age END) AS C0 FROM person AS T0", sql);
    }

    public void testSum() throws Exception {
        final String sql = person.age.gt(20L).then(person.age).sum().showQuery(new GenericDialect());
        assertSimilar("SELECT SUM(CASE WHEN T0.age > ? THEN T0.age END) AS C0 FROM person AS T0", sql);
    }

    public void testMin() throws Exception {
        final String sql = person.age.gt(20L).then(person.age).min().showQuery(new GenericDialect());
        assertSimilar("SELECT MIN(CASE WHEN T0.age > ? THEN T0.age END) AS C0 FROM person AS T0", sql);
    }

    public void testMax() throws Exception {
        final String sql = person.age.gt(20L).then(person.age).max().showQuery(new GenericDialect());
