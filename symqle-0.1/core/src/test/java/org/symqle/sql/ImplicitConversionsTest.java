...
public class ImplicitConversionsTest extends TestCase {
    ...
    public void testQueryExpression() throws Exception {
        final Symqle simqle = Symqle.get();
    ...
    public void testQueryPrimary() throws Exception {
        final Symqle simqle = Symqle.get();
        final AbstractAggregateFunction<Integer> count = person.id.count();
        final AggregateSelectSublist<Integer> selectSublist = simqle.z$AggregateSelectSublist$from$AggregateFunction(count);
        final QueryPrimary<Integer> queryPrimary = simqle.z$QueryPrimary$from$AggregateSelectSublist(selectSublist);
    ...
    public void testAlternateWayToOrderBy() {
        ...
        final Symqle simqle = Symqle.get();
        {
            ...
            final String sql2 = simqle.orderBy(simqle.z$QueryExpression$from$QueryBase(column), person.id).show();
        ...
        }
        {
            ...
            final String sql2 = simqle.orderBy(simqle.z$QueryExpression$from$QueryBase(parameter), person.id).show();
            assertEquals(sql1, sql2);
        }
        {
        ...
        }
        {
            ...
            final String sql2 = simqle.orderBy(simqle.z$QueryExpression$from$QueryBase(numericExpression), person.id).show();
            assertEquals(sql1, sql2);
        }
        {
            final AbstractTerm<Number> term = person.id.mult(2);
            final String sql1 = term.orderBy(person.id).show();
            final String sql2 = simqle.orderBy(simqle.z$QueryExpression$from$QueryBase(term), person.id).show();
            assertEquals(sql1, sql2);
        ...
        }
        {
            ...
            final String sql2 = simqle.orderBy(simqle.z$QueryExpression$from$QueryBase(factor), person.id).show();
            assertEquals(sql1, sql2);
        ...
        }
        {
            ...
            final String sql2 = simqle.orderBy(simqle.z$QueryExpression$from$QueryBase(routineInvocation), person.id).show();
            assertEquals(sql1, sql2);
        }
        {
            ...
            final String sql2 = simqle.orderBy(simqle.z$QueryExpression$from$QueryBase(whenClause), person.id).show();
            assertEquals(sql1, sql2);
        }
        {
            ...
            final String sql2 = simqle.orderBy(simqle.z$QueryExpression$from$QueryBase(whenClauseBaseList), person.id).show();
            assertEquals(sql1, sql2);
        }
        {
            ...
            final String sql2 = simqle.orderBy(simqle.z$QueryExpression$from$QueryBase(whenClauseList), person.id).show();
            assertEquals(sql1, sql2);
        }
        {
            ...
            final String sql2 = simqle.orderBy(simqle.z$QueryExpression$from$QueryBase(stringExpression), person.id).show();
            assertEquals(sql1, sql2);
        }
        {
            ...
            final String sql2 = simqle.orderBy(simqle.z$QueryExpression$from$QueryBase(valueExpression), person.id).show();
            assertEquals(sql1, sql2);
        }
        {
            ...
            final String sql2 = simqle.orderBy(simqle.z$QueryExpression$from$QueryBase(valueExpressionPrimary), person.id).show();
            assertEquals(sql1, sql2);
        }
    }
//
