...
//        assertEquals("MySQL", dataSourceGate.initialContext().get(Dialect.class).getName());
//
...
//        assertNotNull(dataSourceGate.getConnection());
//
//        assertEquals("Generic", dataSourceGate.initialContext().get(Dialect.class).getName());
//
...
//            assertNotNull(dataSourceGate.getConnection());
//
//            assertEquals("Apache Derby", dataSourceGate.initialContext().get(Dialect.class).getName());
...
//
//        try {
//            final Dialect dialect = dataSourceGate.initialContext().get(Dialect.class);
