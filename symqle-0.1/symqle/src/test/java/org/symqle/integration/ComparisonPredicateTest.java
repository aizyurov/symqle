...
public class ComparisonPredicateTest extends AbstractIntegrationTestBase {
     ...
     * @return
     */
    private AbstractComparisonPredicate createBasicCondition(final Employee employee) {
        return employee.lastName.eq("Cooper");
    }

    public void testAnd() throws Exception {
        final Employee employee = new Employee();
        final AbstractComparisonPredicate basicCondition = createBasicCondition(employee);
