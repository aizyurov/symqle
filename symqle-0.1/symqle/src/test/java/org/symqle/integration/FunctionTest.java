   ...
   public void testDistinct() throws Exception {
    ...
    public void testBooleanValue() throws Exception {
        ...
        try {
            ...
            // org.postgresql.util.PSQLException: ERROR: argument of WHERE must be type boolean, not type double precision
    ...
    public void testOrderByNullsFirst() throws Exception {
        final Employee employee = new Employee();
        try {
            final List<String> list = employee.lastName.orderBy(abs(employee.deptId).nullsFirst(), employee.lastName).list(getEngine());
    ...
    public void testOrderByNullsLast() throws Exception {
        final Employee employee = new Employee();
        try {
            final List<String> list = employee.lastName.orderBy(abs(employee.deptId).nullsLast(), employee.lastName).list(getEngine());
    ...
    public void testAsc() throws Exception {
        final Employee employee = new Employee();
        final List<String> list = employee.lastName.orderBy(abs(employee.salary.opposite()).asc(), employee.lastName).list(getEngine());
        assertEquals(Arrays.asList("Cooper", "March", "Pedersen", "First", "Redwood"), list);
    }

    public void testDesc() throws Exception {
        final Employee employee = new Employee();
        final List<String> list = employee.lastName.orderBy(abs(employee.salary.opposite()).desc(), employee.lastName).list(getEngine());
    ...
    public void testDiv() throws Exception {
        final Employee employee = new Employee();
        final List<Number> list = abs(employee.salary.opposite()).div(employee.department().manager().salary.div(100)).orderBy(employee.lastName).list(getEngine());
    ...
    public void testExists() throws Exception {
        ...
        final List<String> list = employee.lastName.where(abs(one.id).exists()).list(getEngine());
