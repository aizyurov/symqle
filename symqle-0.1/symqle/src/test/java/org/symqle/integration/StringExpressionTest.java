...
public class StringExpressionTest extends AbstractIntegrationTestBase {
   ...
   public void testOrderBy() throws Exception {
       final Employee employee = new Employee();
       final List<String> list = stringExpression(employee).orderBy(employee.firstName).list(getEngine());
       assertEquals(Arrays.asList("Alex, my friend", "Bill, my friend", "James, my friend", "James, my friend", "Margaret, my friend"), list);
   }
    ...
    public void testUnionAll() throws Exception {
        ...
        final List<String> list = stringExpression(employee).unionAll(department.manager().firstName.concat(", manager")).list(getEngine());
        Collections.sort(list);
    ...
    public void testUnionDistinct() throws Exception {
        ...
        final Department department = new Department();
        try {
            final List<String> list = stringExpression(employee).unionDistinct(department.manager().firstName.concat(", manager")).list(getEngine());
            Collections.sort(list);
    ...
    public void testUnion() throws Exception {
        ...
        final Department department = new Department();
        try {
            final List<String> list = stringExpression(employee).union(department.manager().firstName.concat(", manager")).list(getEngine());
            Collections.sort(list);
            assertEquals(Arrays.asList("Alex, my friend", "Bill, my friend", "James, manager", "James, my friend", "Margaret, manager", "Margaret, my friend"), list);
        } catch (SQLException e) {
            // derby: ERROR X0X67: Columns of type 'LONG VARCHAR' may not be used in CREATE INDEX, ORDER BY,
    ...
    public void testIntersect() throws Exception {
        ...
        final Department department = new Department();
        try {
            final List<String> list = stringExpression(employee).intersect(department.manager().firstName.concat(", my friend")).list(getEngine());
            Collections.sort(list);
            assertEquals(Arrays.asList("James, my friend", "Margaret, my friend"), list);
        } catch (SQLException e) {
            // derby: ERROR X0X67: Columns of type 'LONG VARCHAR' may not be used in CREATE INDEX, ORDER BY,
    ...
    public void testIntersectDistinct() throws Exception {
        ...
        final Department department = new Department();
        try {
            final List<String> list = stringExpression(employee).intersectDistinct(department.manager().firstName.concat(", my friend")).list(getEngine());
            Collections.sort(list);
            assertEquals(Arrays.asList("James, my friend", "Margaret, my friend"), list);
        } catch (SQLException e) {
            // derby: ERROR X0X67: Columns of type 'LONG VARCHAR' may not be used in CREATE INDEX, ORDER BY,
    ...
    public void testExceptDistinct() throws Exception {
        ...
        final Department department = new Department();
        try {
            final List<String> list = stringExpression(employee).exceptDistinct(department.manager().firstName.concat(", my friend")).list(getEngine());
            Collections.sort(list);
    ...
    public void testExcept() throws Exception {
        ...
        final Department department = new Department();
        try {
            final List<String> list = stringExpression(employee).except(department.manager().firstName.concat(", my friend")).list(getEngine());
            Collections.sort(list);
            assertEquals(Arrays.asList("Alex, my friend", "Bill, my friend"), list);
        } catch (SQLException e) {
            // derby: ERROR X0X67: Columns of type 'LONG VARCHAR' may not be used in CREATE INDEX, ORDER BY,
    ...
    public void testPosition() throws Exception {
        final Employee employee = new Employee();
        final List<Integer> list = stringExpression(employee).positionOf("gare").where(employee.lastName.eq("Redwood")).list(getEngine());
    ...
    public void testAvg() throws Exception {
        final One one = new One();
        try {
            final List<Number> list = one.id.concat("2").avg().list(getEngine());
            assertEquals(1, list.size());
