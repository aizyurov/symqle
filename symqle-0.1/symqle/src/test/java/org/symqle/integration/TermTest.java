...
public class TermTest extends AbstractIntegrationTestBase {
    ...
    public void testCast() throws Exception {
        final Employee employee = new Employee();
        final List<Double> list = toListOfDouble(createTerm(employee).cast("DECIMAL(7,2)").list(getEngine()));
        Collections.sort(list);
        assertEquals(Arrays.asList(-3000.0, -3000.0, -2000.0, -2000.0, -1500.0), list);
    }
    ...
    public void testWhere() throws Exception {
        final Employee employee = new Employee();
        final List<Double> list = toListOfDouble(createTerm(employee).where(employee.retired.asPredicate().negate()).list(getEngine()));
        Collections.sort(list);
    ...
    public void testPair() throws Exception {
        final Employee employee = new Employee();
        final List<Pair<Number, String>> list = createTerm(employee).pair(employee.lastName).where(employee.retired.asPredicate()).list(getEngine());
    ...
    public void testEq() throws Exception {
        final Employee employee = new Employee();
        final List<String> list = employee.lastName.where(createTerm(employee).eq(employee.salary.add(0))).list(getEngine());
    ...
    public void testAdd() throws Exception {
        final Employee employee = new Employee();
        final List<Number> list = createTerm(employee).add(employee.salary.mult(2)).list(getEngine());
    ...
    public void testSub() throws Exception {
        final Employee employee = new Employee();
        final List<Number> list = createTerm(employee).sub(employee.salary.mult(2).opposite()).list(getEngine());
        final List<Double> actual = new ArrayList<Double>();
        for (Number number : list) {
            actual.add(number.doubleValue());
        }
    ...
    public void testAddNumber() throws Exception {
        final Employee employee = new Employee();
        final List<Number> list = createTerm(employee).add(3000.0).list(getEngine());
        final List<Double> actual = new ArrayList<Double>();
        for (Number number : list) {
            actual.add(number.doubleValue());
        }
    ...
    public void testSubNumber() throws Exception {
        final Employee employee = new Employee();
        final List<Number> list = createTerm(employee).sub(500.0).list(getEngine());
        final List<Double> actual = new ArrayList<Double>();
        for (Number number : list) {
            actual.add(number.doubleValue());
        }
    ...
    public void testOrderBy() throws Exception {
        final Employee employee = new Employee();
        final List<Double> list = toListOfDouble(createTerm(employee).orderBy(createTerm(employee)).list(getEngine()));
        assertEquals(Arrays.asList(-3000.0, -3000.0, -2000.0, -2000.0, -1500.0), list);
    }
    ...
    public void testOrderByNullsFirst() throws Exception {
        final Employee employee = new Employee();
        try {
            final List<Double> list = toListOfDouble(createTerm(employee).orderBy(createTerm(employee).nullsFirst()).list(getEngine()));
            assertEquals(Arrays.asList(-3000.0, -3000.0, -2000.0, -2000.0, -1500.0), list);
        } catch (SQLException e) {
    ...
    public void testOrderByNullsLast() throws Exception {
        final Employee employee = new Employee();
        try {
            final List<Double> list = toListOfDouble(createTerm(employee).orderBy(createTerm(employee).nullsLast()).list(getEngine()));
            assertEquals(Arrays.asList(-3000.0, -3000.0, -2000.0, -2000.0, -1500.0), list);
        } catch (SQLException e) {
            // mysql does not support NULLS FIRST
            expectSQLException(e, "MySQL");
    ...
    public void testOrderByAsc() throws Exception {
        final Employee employee = new Employee();
        final List<Double> list = toListOfDouble(createTerm(employee).orderBy(createTerm(employee).asc()).list(getEngine()));
        assertEquals(Arrays.asList(-3000.0, -3000.0, -2000.0, -2000.0, -1500.0), list);
    }

    public void testOrderByDesc() throws Exception {
        final Employee employee = new Employee();
        final List<Double> list = toListOfDouble(createTerm(employee).orderBy(createTerm(employee).desc()).list(getEngine()));
        assertEquals(Arrays.asList(-1500.0, -2000.0, -2000.0, -3000.0, -3000.0), list);
    }

    public void testUnionAll() throws Exception {
        final Employee employee = new Employee();
        final List<Double> list = toListOfDouble(createTerm(employee).unionAll(employee.salary.mult(1).where(employee.lastName.eq("Cooper"))).list(getEngine()));
        Collections.sort(list);
    ...
    public void testUnionDistinct() throws Exception {
        final Employee employee = new Employee();
        final List<Double> list = toListOfDouble(createTerm(employee).unionDistinct(employee.salary.mult(-1).where(employee.lastName.eq("Cooper"))).list(getEngine()));
        Collections.sort(list);
        assertEquals(Arrays.asList(-3000.0, -2000.0, -1500.0), list);
    ...
    public void testUnion() throws Exception {
        final Employee employee = new Employee();
        final List<Double> list = toListOfDouble(createTerm(employee).union(employee.salary.mult(-1).where(employee.lastName.eq("Cooper"))).list(getEngine()));
        Collections.sort(list);
        assertEquals(Arrays.asList(-3000.0, -2000.0, -1500.0), list);
    ...
    public void testExceptAll() throws Exception {
        final Employee employee = new Employee();
        try {
            final List<Double> list = toListOfDouble(createTerm(employee).exceptAll(createTerm(employee).where(employee.lastName.eq("Cooper"))).list(getEngine()));
            Collections.sort(list);
            assertEquals(Arrays.asList(-3000.0, -3000.0, -2000.0, -2000.0), list);
        } catch (SQLException e) {
    ...
    public void testExceptDistinct() throws Exception {
        final Employee employee = new Employee();
        try {
            final List<Double> list = toListOfDouble(createTerm(employee).exceptDistinct(createTerm(employee).where(employee.lastName.eq("Cooper"))).list(getEngine()));
            Collections.sort(list);
    ...
    public void testExcept() throws Exception {
        final Employee employee = new Employee();
        try {
            final List<Double> list = toListOfDouble(createTerm(employee).except(createTerm(employee).where(employee.lastName.eq("Cooper"))).list(getEngine()));
            Collections.sort(list);
            assertEquals(Arrays.asList(-3000.0, -2000.0), list);
        } catch (SQLException e) {
            // mysql: does not support EXCEPT
    ...
    public void testIntersectAll() throws Exception {
        final Employee employee = new Employee();
        try {
            final List<Double> list = toListOfDouble(createTerm(employee).intersectAll(createTerm(employee).where(employee.lastName.ne("Cooper"))).list(getEngine()));
            Collections.sort(list);
            assertEquals(Arrays.asList(-3000.0, -3000.0, -2000.0, -2000.0), list);
        } catch (SQLException e) {
    ...
    public void testIntersectDistinct() throws Exception {
        final Employee employee = new Employee();
        try {
            final List<Double> list = toListOfDouble(createTerm(employee).intersectDistinct(createTerm(employee).where(employee.lastName.ne("Cooper"))).list(getEngine()));
            Collections.sort(list);
            assertEquals(Arrays.asList(-3000.0, -2000.0), list);
        } catch (SQLException e) {
            // mysql: does not support INTERSECT
    ...
    public void testIntersect() throws Exception {
        final Employee employee = new Employee();
        try {
            final List<Double> list = toListOfDouble(createTerm(employee).intersect(createTerm(employee).where(employee.lastName.ne("Cooper"))).list(getEngine()));
            Collections.sort(list);
            assertEquals(Arrays.asList(-3000.0, -2000.0), list);
        } catch (SQLException e) {
            // mysql: does not support INTERSECT
    ...
    public void testQueryValueNegative() throws Exception {
        ...
        final Employee employee = new Employee();
        try {
            createTerm(employee).queryValue().pair(department.deptName).list(getEngine());
    ...
    public void testWhenClause() throws Exception {
        final Employee employee = new Employee();
        final List<Double> list = toListOfDouble(employee.retired.asPredicate().then(createTerm(employee)).orElse(employee.salary.add(0)).list(getEngine()));
        Collections.sort(list);
        assertEquals(Arrays.asList(-1500.0, 2000.0, 2000.0, 3000.0, 3000.0), list);
    }
    ...
    public void testElse() throws Exception {
        final Employee employee = new Employee();
        final List<Double> list = toListOfDouble(employee.retired.asPredicate().negate().then(employee.salary.add(0)).orElse(createTerm(employee)).list(getEngine()));
        Collections.sort(list);
        assertEquals(Arrays.asList(-1500.0, 2000.0, 2000.0, 3000.0, 3000.0), list);
    }
